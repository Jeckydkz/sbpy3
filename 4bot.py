...
line = LINE("EvcYfQ1Q4q80pSz1aiS8.b4re+siOQKBPRGa4c2OuEa.c/OXs6oXo5AptwyuVS/7i9dlXPKzSbzvQN2sPUe1WvM=")
line.log("Auth Token : " + str(line.authToken))
line.log("Timeline Token : " + str(line.tl.channelAccessToken))

ki = LINE("EvHY0e64BgBAaMrXRrSf.zO91+/5NiDEQ1GmG5Az9JW.NfapQieGNjeO3dev/yzEc+H5ong4iiWSvZpPWAjMVHY=")
ki.log("Auth Token : " + str(ki.authToken))
ki.log("Timeline Token : " + str(ki.tl.channelAccessToken))

ki2 = LINE("Ev3H17f2TaUwHLeKBZ41.UYeH0c6w9uF6zIIf9Z0Eiq.0N0SF3ZOynch7O33HgRzwz/r9ehWbAkMh6aItn9Y/Ks=")
ki2.log("Auth Token : " + str(ki2.authToken))
ki2.log("Timeline Token : " + str(ki2.tl.channelAccessToken))

ki3 = LINE("EvAmJNBNoGHd7stE4EJd.BGiDmYF9qmYNa3najI55lq.sQ49DeJ+lPLRO1wH1DJEqUoa0/n6dTiYKt+NhiLQZ2E=")
ki3.log("Auth Token : " + str(ki3.authToken))
ki3.log("Timeline Token : " + str(ki3.tl.channelAccessToken))

ki4 = LINE("Evx5PM8eZP7rCYFYZSM7.r0jeauC+dMvZah6T+cEcPW.pKyLUsmm5D81xGdkHx1EciusU/ScfGvCNHmfsAVbIss=")
